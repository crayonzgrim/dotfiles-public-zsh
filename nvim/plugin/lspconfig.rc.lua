...
--
-- 	if client.name == "tsserver" then
-- 		vim.keymap.set("n", "<leader>tr", ":TypescriptRenameFile<CR>", opts) -- rename file and update imports
-- 		vim.keymap.set("n", "<leader>ti", ":TypescriptOrganizeImports<CR>", opts) -- organize imports
-- 		vim.keymap.set("n", "<leader>tu", ":TypescriptRemoveUnused<CR>", opts) -- remove unused variables
-- 	end
--
